...
public class Fenetre_affichage_recherche_personnage {
    ...
    public Fenetre_affichage_recherche_personnage(Fenetre fenetre) {
    ...
    public void affichage(String name) {
        Requete_api_recherche_personnage requete = new Requete_api_recherche_personnage();
        JSONObject json_response = requete.recherche(name);

        Lecture_fichier_json lecture = new Lecture_fichier_json();
        reponse = lecture.lecture(json_response);
    ...
    private void updatePage() {
        ...
        for (int i = start; i < end; i++) {
            JPanel panel = createResultPanel(reponse[i][0], reponse[i][1], reponse[i][5]);
